...
<p align="center">
	<img src="https://l.top4top.io/p_2487a6pd40.jpg" width="35%" style="margin-left: auto;margin-right: auto;display: block;">
</p>
<h1 align="center">presented by hr999x</h1>

This is Script of WhatsApp multi device, working with [`@adiwajshing/baileys`](https://github.com/adiwajshing/baileys)

## My Project
* New script to replace this script [`look here`](https://github.com/ItsmeHndrr/bot-whatsapp) (`MULTI DEVICE `)
...
```bash
git clone https://github.com/ItsmeHndrr/bot-whatsapp 
cd bot-whatsapp 
npm install
```
...
git clone https://github.com/IysmeHndrr/bot-whatsapp 
cd bot-whatsapp 
npm install
```
...
* [`Hr999x`](https://github.com/ItsmeHndrr)
